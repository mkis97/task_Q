<template>
  <div class="relative border border-grey px-6 pt-4 pb-6 rounded bg-white cursor-pointer shadow-md max-w-lg"
    ...
    <i v-if="showMoreIcon" class="bi bi-chat-dots-fill absolute bottom-3 right-3" @click.stop="openComments"/>
  </div>
</template>
